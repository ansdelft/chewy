...
describe Chewy do
  ...
  describe '.client' do
    ...
    specify do
      ...
      expect(::OpenSearch::Client).to receive(:new).with(expected_client_config) do |*_args, &passed_block|
      ...
      expect(Chewy.client).to be_a(Chewy::OpensearchClient)
    end
  ...
  describe '.create_indices' do
    ...
    specify '.create_indices!' do
      ...
      expect { Chewy.create_indices! }.to raise_error(OpenSearch::Transport::Transport::Errors::BadRequest)
    end
  end
end
